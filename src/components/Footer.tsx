...
export default function Footer() {
  return (
    <footer className="bg-surface text-textDark py-12 px-4 sm:px-6 lg:px-8 border-t border-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-textSecondary">
              ...
              em beleza para noivas e madrinhas.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-playfair font-bold text-textDark mb-4">
              Links Rápidos
            </h4>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="w-10 h-10 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary hover:text-surface transition-colors text-primary"
                aria-label="WhatsApp"
              >
                <svg
                  className="w-5 h-5"
